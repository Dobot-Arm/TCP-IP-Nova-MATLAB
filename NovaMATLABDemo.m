classdef NovaMATLABDemo < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function UIFigureWindowButtonUp(app, event)
            if app.IsMoveJog
                ...
                write(app.DashboardClient,"MoveJog()","char");
               % pause(1);
                res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
                app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
            end
        ...
        function UIFigureWindowButtonDown(app, event)
            if event.Source.CurrentObject.Tag ~= ""
                ...
                write(app.DashboardClient,"MoveJog("+event.Source.CurrentObject.Tag+")","char")
                %pause(1);
                res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
                app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
            end
        ...
        function MovJButtonPushed(app, event)
            ...
            write(app.DashboardClient,"MovJ("+app.XEditField.Value+","+app.YEditField.Value+","+app.ZEditField.Value+","+app.RXEditField.Value+","+app.RYEditField.Value+","+app.RZEditField.Valuec+")","char");
            pause(1);
            res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
            app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
        end
        ...
        function MovLButtonPushed(app, event)
            ...
            write(app.DashboardClient,"MovL("+app.XEditField.Value+","+app.YEditField.Value+","+app.ZEditField.Value+","+app.RXEditField.Value+","+app.RYEditField.Value+","+app.RZEditField.Valuec+")","char");
            pause(1);
            res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
            app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
        end
        ...
        function JointMovJButtonPushed(app, event)
            ...
            write(app.DashboardClient,"JointMovJ("+app.J1EditField.Value+","+app.J2EditField.Value+","+app.J3EditField.Value+","+app.J4EditField.Value+","+app.J5EditField.Value+","+app.J6EditField.Value+")","char");
        end

        % Button pushed function: StopMoveButton
        function StopMoveButtonPushed(app, event)
            app.LogTextArea.Value{end+1}=['Send:StopRobot()'];
            write(app.DashboardClient,"StopRobot()","char");
            pause(1);
            res=read(app.DashboardClient,app.DashboardClient.NumBytesAvailable);
            app.LogTextArea.Value{end+1}=char(sprintf("Receive:%s",res));
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.FeedBackPortEditField.Position = [609 24 136 27];
            ...
            app.FeedBackPortEditFieldLabel.Position = [511 27 83 22];
            ...
            app.SpeedRatioEditField.Position = [350 55 49 27];
            app.SpeedRatioEditField.Value = '50';
            
            % Create Label
            app.Label = uilabel(app.DashBoardFunctionPanel);
            app.Label.Position = [410 57 25 22];
            app.Label.Text = '%';
            ...
            app.SpeedConfirmButton.Position = [466 57 100 22];
